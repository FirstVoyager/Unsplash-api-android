package limitless.android.unsplash;

import java.util.List;

import androidx.annotation.NonNull;
import androidx.annotation.Nullable;
import limitless.android.unsplash.Api.Endpoints.CollectionsEndpoints;
import limitless.android.unsplash.Api.Endpoints.CurrentUserEndpoints;
import limitless.android.unsplash.Api.Endpoints.PhotosEndpoints;
import limitless.android.unsplash.Api.Endpoints.SearchEndpoints;
import limitless.android.unsplash.Api.HeaderPublic;
import limitless.android.unsplash.Api.HeaderToken;
...
public class Unsplash {
     ...
     * @param login true --> For logged users use token, false --> For public usage
     */
    public Unsplash(@NonNull String key, boolean login){
